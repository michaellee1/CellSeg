...
def display_raw_instances(image, masks,
                      scores=None, title="",
                      figsize=(16, 16), ax=None,
                      show_mask=True, show_bbox=True,
                      colors=None, captions=None):
...
# def display_raw_instances(image, masks, class_names,
#                       scores=None, title="",
#                       figsize=(16, 16), ax=None,
#                       show_mask=True, show_bbox=True,
#                       colors=None, captions=None):
...
def generate_instances_and_save(path, image, masks,
                      scores=None, title="",
                      figsize=(25, 25),
                      show_mask=True, show_bbox=True,
                      colors=None, captions=None):
    ...
    for i in range(N):
        ...
        for verts in contours:
            # Subtract the padding and flip (y, x) to (x, y)
            verts = np.fliplr(verts) - 1
            p = Polygon(verts, facecolor="none", edgecolor=color, lw=3)
            ax.add_patch(p)
    ax.axis('off')
    img = ax.imshow(image.astype(np.uint8))
...
def generate_masks_and_save(path, image, masks,
                      scores=None, title="",
                      figsize=(15, 15),
                      show_mask=True, show_bbox=True,
                      colors=None, captions=None):
    ...
    x, y, z = image.shape
    frame = np.zeros((x,y,1), dtype=np.uint8)
